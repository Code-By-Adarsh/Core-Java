...
public class Polymorphism_in_interface {
    public static void main(String[] args) {
        /*
        Chapter11_AbstractClassesAndInterfaces.Smartphone1 s = new Chapter11_AbstractClassesAndInterfaces.Smartphone1();
        s.takephoto();
        s.takevideo();
        s.sharelocation();
        s.mylocation();
        ...
        s.find();
         */
        Map1 m = new Smartphone1();//----->This is Chapter10_Inheritence.smartphone but use it as a map.
        m.sharelocation();
