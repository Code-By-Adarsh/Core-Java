...
public class time {
    public static void main(String[] args) {
        ...
        //👉 java.Topic_TimeAPI.time package (isme LocalDate, LocalTime, LocalDateTime etc. aate hain)
        ...
        //For expert in java.Topic_TimeAPI.time package only visit java 24 docs.
    }
}